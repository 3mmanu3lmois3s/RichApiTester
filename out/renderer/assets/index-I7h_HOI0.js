...
function TestApiMock() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl font-bold mb-4" }, "Test API Mock"), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("label", { className: "block font-semibold mb-1" }, "Base URL:"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
    ...
    "Cargar Endpoints"
  )), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("label", { className: "block font-semibold mb-1" }, "Seleccionar Endpoint:"), /* @__PURE__ */ React.createElement(
    "select",
    {
      className: "border p-2 w-full",
    ...
    endpoints.length === 0 && /* @__PURE__ */ React.createElement("option", { value: -1 }, "-- Sin endpoints cargados --"),
    endpoints.map((ep, idx) => /* @__PURE__ */ React.createElement("option", { key: idx, value: idx }, ep.method, " ", ep.path))
  )), selectedEndpoint && /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold" }, "Parámetros:"), Object.keys(params).length === 0 ? /* @__PURE__ */ React.createElement("p", { className: "text-gray-500" }, "No hay parámetros en la ruta") : Object.keys(params).map((pName) => /* @__PURE__ */ React.createElement("div", { key: pName, className: "mb-2" }, /* @__PURE__ */ React.createElement("label", { className: "mr-2" }, pName, ":"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      className: "border p-1",
      value: params[pName],
      onChange: (e) => setParams({ ...params, [pName]: e.target.value })
    }
  )))), selectedEndpoint && (selectedEndpoint.method === "POST" || selectedEndpoint.method === "PUT") && /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold" }, "Body JSON (opcional):"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      className: "border p-2 w-full",
      rows: "4",
    ...
    "Enviar"
  )), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold" }, "Respuesta:"), /* @__PURE__ */ React.createElement("pre", { className: "bg-gray-100 p-2 border min-h-[80px] whitespace-pre-wrap" }, response)), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold" }, "Vista del Webview:"), baseUrl ? /* @__PURE__ */ React.createElement(
    "webview",
    {
      ref: webviewRef,
  ...
  ) : /* @__PURE__ */ React.createElement("p", { className: "text-gray-500" }, 'Ingresa la Base URL y presiona "Cargar Endpoints" para ver la vista.')));
}
const initialState = {
  tabs: [],
  activeIndex: null,
...
function tabsReducer(state, action) {
  switch (action.type) {
    ...
    case "EDIT_TAB": {
      ...
      const updatedTabs = state.tabs.map(
        (tab, i) => i === index ? { ...tab, title: newTitle } : tab
      );
...
function Tabs() {
  const [state, dispatch] = reactExports.useReducer(tabsReducer, initialState);
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "h-full flex flex-col" }, /* @__PURE__ */ React.createElement("div", { className: "flex overflow-x-auto bg-gray-200 p-2 space-x-1" }, state.tabs.map((tab, i) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: tab.id,
      onClick: () => setActive(i),
      className: `flex-shrink-0 px-2 py-1 mx-1 cursor-pointer rounded 
              ${tab.type === "mock" ? "bg-blue-300 hover:bg-blue-400" : tab.type === "real" ? "bg-green-300 hover:bg-green-400" : "bg-purple-300 hover:bg-purple-400"}
    ...
    "button",
    {
      ...
      onClick: () => addTab("Test API Mock", /* @__PURE__ */ React.createElement(TestApiMock, null), "mock")
    },
    "+Mock"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      onClick: () => addTab("Test API Real", /* @__PURE__ */ React.createElement(RealApiView, null), "real")
    },
    "+Real"
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      onClick: () => addTab("Orchestrator", /* @__PURE__ */ React.createElement(OrchestratorView, null), "orch")
    },
    "+Orch"
  )), /* @__PURE__ */ React.createElement("div", { className: "flex-1 bg-white p-4" }, state.activeIndex !== null && state.tabs[state.activeIndex] ? state.tabs[state.activeIndex].content : /* @__PURE__ */ React.createElement("p", { className: "text-gray-500" }, "No hay pestañas abiertas")));
}
function EditableLabel({ initialValue, onSave }) {
  const [editing, setEditing] = reactExports.useState(false);
  const [value, setValue] = reactExports.useState(initialValue);
  return editing ? /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      className: "text-sm",
  ...
  ) : /* @__PURE__ */ React.createElement("span", { onDoubleClick: () => setEditing(true), className: "text-sm" }, value);
}
function RealApiView() {
  return /* @__PURE__ */ React.createElement("div", null, "Vista de Real API");
}
function OrchestratorView() {
  return /* @__PURE__ */ React.createElement("div", null, "Vista de Orquestador");
}
function App() {
  return /* @__PURE__ */ React.createElement("div", { className: "w-full h-full" }, /* @__PURE__ */ React.createElement(Tabs, null));
}
